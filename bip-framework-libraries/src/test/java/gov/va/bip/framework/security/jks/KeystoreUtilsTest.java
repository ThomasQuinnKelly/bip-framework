...
public class KeystoreUtilsTest {
	...
	@Test
	public void testCreateClientStore() throws Exception {
		final String privateKey = "-----BEGIN PRIVATE KEY-----\n" + 
				...
				"-----END PRIVATE KEY-----\n" + 
				"";
		final String publicCert = "-----BEGIN CERTIFICATE-----\n" + 
		...
		KeyStore result = KeystoreUtils.createClientStore(publicCert, privateKey, privateKeyPassword, alias);
		...
		assertEquals(privateKey.replace("\n", ""), encodedPK);
		...
		assertEquals(publicCert.replace("\n", ""), encodedCert);
