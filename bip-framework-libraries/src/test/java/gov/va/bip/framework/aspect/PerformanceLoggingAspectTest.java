...
public class PerformanceLoggingAspectTest extends AbstractBaseLogTester {
	...
	private BipLogger AspectLoggingLOG = super.getLogger(PerformanceLoggingAspect.class);
	/** Underlying logger implementation of BipLogger */
	private BipLogger AspectLoggingTestLOG = super.getLogger(PerformanceLoggingAspectTest.class);
