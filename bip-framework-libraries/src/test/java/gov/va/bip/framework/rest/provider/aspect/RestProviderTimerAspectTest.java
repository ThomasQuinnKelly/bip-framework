...
public class RestProviderTimerAspectTest extends AbstractBaseLogTester {
	...
	private BipLogger AspectLoggingLOG = super.getLogger(RestProviderTimerAspectTest.class);
	/** Underlying implementation of BipLogger */
	private BipLogger AspectLoggingTestLOG = super.getLogger(RestProviderTimerAspectTest.class);
