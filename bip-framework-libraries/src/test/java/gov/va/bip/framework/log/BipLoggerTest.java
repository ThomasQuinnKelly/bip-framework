...
public class BipLoggerTest extends AbstractBaseLogTester {
	...
	private BipLogger logger = super.getLogger(BipLoggerTest.class);
	private static final MessageKey TEST_KEY = MessageKeys.NO_KEY;

	private final BipBanner banner = BipBanner.newBanner("TEST BANNER", Level.INFO);
	private static final String MESSAGE = "Test message";
	private static final Marker MARKER = BipLogMarkers.TEST.getMarker();
	private static final BipRuntimeException EXCEPTION =
	 ...
	 */
	private void assertConsoleBanner(final Level level, final BipBanner banner, final String message, final Exception e)
			throws IOException {
		// output capture
	...
	public final void testLargeMessageWithLargeStackTrace() {
		...
		Exception e = new BipRuntimeException(TEST_KEY,
	...
	public final void testGetName() throws IOException {
		...
		assertNotNull(name);
		assertTrue(BipLoggerTest.class.getName().equals(name));
	}
