 ...
 *
 */
public class BipMaskingFilter extends EventEvaluatorBase<ILoggingEvent> {
	/** Class logger */
	private static final BipLogger LOGGER = BipLoggerFactory.getLogger(BipMaskingFilter.class);
	 ...
	 * Otherwise, use {@link #BipMaskingFilter(String, String, String, String, int)}.
	 * <p>
	 ...
	 * @throws BipRuntimeException - if some programming issue causes reflection to fail
	 */
	...
	public String toString() {
		return "BipMaskingFilter [name=" + super.getName() + ", prefix=" + prefix + ", suffix=" + suffix + ", pattern=" + pattern
				+ ", unmasked=" + unmasked + "]";
	}
}
