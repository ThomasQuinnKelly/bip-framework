...
/**
 * This class is intended to supplement the configurable logback masking that is built in to the BIP Framework.
 * <br/>
 ...
 * href="https://github.com/department-of-veterans-affairs/bip-reference-person/blob/master/docs/log-audit-management.md">Log and Audit
 * Management</a>
 * <p>
 * This class provides:
 * <ul>
 ...
 * with methods added to suit the purposes of BIP Framework.
 * <br/>
 * See <a
