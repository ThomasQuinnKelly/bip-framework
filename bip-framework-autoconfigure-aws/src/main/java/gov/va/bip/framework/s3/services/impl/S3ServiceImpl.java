...
public class S3ServiceImpl implements S3Service {
	...
	public Bucket createBucket(String bucketName) {
		...
		try {
			...
			if (e.getMessage() != null)
				throw new S3Exception(MessageKeys.BIP_S3_CREATE_BUCKET_EXCEPTION_MESSAGE, MessageSeverity.ERROR,
	...
	public Bucket createBucket(CreateBucketRequest createBucketRequest) {
		...
		try {
			Defense.notNull(createBucketRequest, "CreateBucketRequest can't be null.");
			Defense.notNull(createBucketRequest.getBucketName(), "CreateBucketRequest.getBucketName() can't be null.");
